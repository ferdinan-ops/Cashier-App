...
Public Class Lap_Jual_Tahun
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.Lap_Jual_Tahun.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLap_Jual_Tahun
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Lap_Jual_Tahun = New Lap_Jual_Tahun()
        rpt.Site = Me.Site
        Return rpt
    End Function
